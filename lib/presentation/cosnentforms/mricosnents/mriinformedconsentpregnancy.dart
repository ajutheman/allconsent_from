...
class MriInformedConsentPregnancy extends StatelessWidget {
  ...
  MriInformedConsentPregnancy({super.key, required consentRequest}) {
  ...
  Widget build(BuildContext context) {
    return SingleChildScrollView(
      child: Column(
        ...
        children: [
          AppBar(title: const Text("Permission Consent for MRI")),
          InputWidget.TitleWidget(
              "PERMISSION AND INFORMED CONSENT FOR PREGNANACY MRI"),
          InputWidget.SubTitle("1. PERMISSION:"),
          InputWidget.ParagraphWidget(
              "hereby authorize Doctor ${consentReq.doctorName.toString()} or his/her associates or his/her assistants or his/her choice Al Etihad Diagnostic Center Radiology to perform upon me an MRI requested by my Dr. ${consentReq.doctorName.toString()}."),
